...
return [(function (){var pred__1114 = cljs.core.instance_QMARK_;
var expr__1115 = reactive_val;
if(cljs.core.truth_(pred__1114.call(null,reagent.ratom.RAtom,expr__1115))){
return "ra";
} else {
if(cljs.core.truth_(pred__1114.call(null,reagent.ratom.RCursor,expr__1115))){
return "rc";
} else {
if(cljs.core.truth_(pred__1114.call(null,reagent.ratom.Reaction,expr__1115))){
return "rx";
} else {
if(cljs.core.truth_(pred__1114.call(null,reagent.ratom.Track,expr__1115))){
return "tr";
} else {
return "other";
}

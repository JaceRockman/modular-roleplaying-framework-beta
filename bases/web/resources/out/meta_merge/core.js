...
return cljs.core.boolean$.call(null,(function (){var or__5045__auto__ = cljs.core.some.call(null,cljs.core.some_fn.call(null,cljs.core.nil_QMARK_,meta_merge.core.displace_QMARK_,meta_merge.core.replace_QMARK_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [left,right], null));
...
if(cljs.core.truth_((function (){var and__5043__auto__ = meta_merge.core.displace_QMARK_.call(null,left);
...
if(cljs.core.truth_((function (){var and__5043__auto__ = meta_merge.core.replace_QMARK_.call(null,left);
if(cljs.core.truth_(and__5043__auto__)){
...
if(cljs.core.truth_((function (){var or__5045__auto__ = meta_merge.core.displace_QMARK_.call(null,left);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return meta_merge.core.replace_QMARK_.call(null,right);
...
if(cljs.core.truth_((function (){var or__5045__auto__ = meta_merge.core.replace_QMARK_.call(null,left);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return meta_merge.core.displace_QMARK_.call(null,right);
...
var len__5769__auto___1832 = arguments.length;
var i__5770__auto___1833 = (0);
while(true){
if((i__5770__auto___1833 < len__5769__auto___1832)){
args_arr__5794__auto__.push((arguments[i__5770__auto___1833]));

var G__1834 = (i__5770__auto___1833 + (1));
i__5770__auto___1833 = G__1834;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var or__5045__auto__ = new cljs.core.Keyword(null,"prepend","prepend",342616040).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,left));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
/** @this {Function} */
(meta_merge.core.meta_merge.cljs$lang$applyTo = (function (seq1827){
var G__1828 = cljs.core.first.call(null,seq1827);
var seq1827__$1 = cljs.core.next.call(null,seq1827);
var G__1829 = cljs.core.first.call(null,seq1827__$1);
var seq1827__$2 = cljs.core.next.call(null,seq1827__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1828,G__1829,seq1827__$2);
}));

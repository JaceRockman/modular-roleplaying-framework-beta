...
return cljs.core.some.call(null,(function (p1__1136_SHARP_){
return ajax.formats.content_type_matches.call(null,content_type,p1__1136_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__1137){
var map__1138 = p__1137;
var map__1138__$1 = cljs.core.__destructure_map.call(null,map__1138);
var request = map__1138__$1;
var response_format = cljs.core.get.call(null,map__1138__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__1140){
var map__1141 = p__1140;
var map__1141__$1 = cljs.core.__destructure_map.call(null,map__1141);
var request = map__1141__$1;
var response_format = cljs.core.get.call(null,map__1141__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__1139_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__1139_SHARP_);
}),formats);
});
/**

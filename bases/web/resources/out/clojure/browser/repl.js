...
var seq__2048_2052 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__2049_2053 = null;
var count__2050_2054 = (0);
var i__2051_2055 = (0);
while(true){
if((i__2051_2055 < count__2050_2054)){
var str_2056 = cljs.core._nth.call(null,chunk__2049_2053,i__2051_2055);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_2056})));


var G__2057 = seq__2048_2052;
var G__2058 = chunk__2049_2053;
var G__2059 = count__2050_2054;
var G__2060 = (i__2051_2055 + (1));
seq__2048_2052 = G__2057;
chunk__2049_2053 = G__2058;
count__2050_2054 = G__2059;
i__2051_2055 = G__2060;
continue;
} else {
var temp__5804__auto___2061 = cljs.core.seq.call(null,seq__2048_2052);
if(temp__5804__auto___2061){
var seq__2048_2062__$1 = temp__5804__auto___2061;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__2048_2062__$1)){
var c__5568__auto___2063 = cljs.core.chunk_first.call(null,seq__2048_2062__$1);
var G__2064 = cljs.core.chunk_rest.call(null,seq__2048_2062__$1);
var G__2065 = c__5568__auto___2063;
var G__2066 = cljs.core.count.call(null,c__5568__auto___2063);
var G__2067 = (0);
seq__2048_2052 = G__2064;
chunk__2049_2053 = G__2065;
count__2050_2054 = G__2066;
i__2051_2055 = G__2067;
continue;
} else {
var str_2068 = cljs.core.first.call(null,seq__2048_2062__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_2068})));


var G__2069 = cljs.core.next.call(null,seq__2048_2062__$1);
var G__2070 = null;
var G__2071 = (0);
var G__2072 = (0);
seq__2048_2052 = G__2069;
chunk__2049_2053 = G__2070;
count__2050_2054 = G__2071;
i__2051_2055 = G__2072;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__2077 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__2077,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__2077,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__2077,"onreadystatechange",onload);

return G__2077;
})();
if((opt_sourceText == null)){
var G__2078 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__2078,"src",src);

return G__2078;
} else {
var G__2079 = script__$1;
goog.dom.setTextContent(G__2079,opt_sourceText);
...
var path_2080 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_2080);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_2080)].join(''));
} else {
var path_2081 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_2081);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_2081);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_2081)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__2082 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__2083 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__2083);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__2082);
}})()})));
}));
